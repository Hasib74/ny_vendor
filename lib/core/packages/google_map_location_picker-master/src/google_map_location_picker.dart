...
import 'package:single_vendor_admin/core/packages/google_map_location_picker-master/generated/l10n.dart';
import 'package:single_vendor_admin/core/packages/google_map_location_picker-master/src/map.dart';
import 'package:single_vendor_admin/core/packages/google_map_location_picker-master/src/providers/location_provider.dart';
import 'package:single_vendor_admin/core/packages/google_map_location_picker-master/src/rich_suggestion.dart';
import 'package:single_vendor_admin/core/packages/google_map_location_picker-master/src/search_input.dart';
import 'package:single_vendor_admin/core/packages/google_map_location_picker-master/src/utils/uuid.dart';
...
class LocationPickerState extends State<LocationPicker> {
  ...
  void searchPlace(String place) {
    ...
    Size? size = renderBox?.semanticBounds?.size;

    final RenderObject? appBarBox = appBarKey.currentContext!.findRenderObject();

    overlayEntry = OverlayEntry(
      builder: (context) => Positioned(
        top: renderBox?.semanticBounds?.size.height,
        width: size!.width,
        child: Material(
          elevation: 1,
          child: Container(
    ...
    MaterialPageRoute<dynamic>(
      builder: (BuildContext context) {
        ...
        return LocationPicker(
          ...
          countries: countries,
          language: language,
          desiredAccuracy: desiredAccuracy, key: Key('locationPicker'),
        );
      },
    ),
  );

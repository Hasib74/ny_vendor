...
import 'package:single_vendor_admin/core/packages/google_map_location_picker-master/src/utils/loading_builder.dart';
import 'package:single_vendor_admin/core/packages/google_map_location_picker-master/src/utils/log.dart';
...
//            },
                ...
                children: <Widget>[
                  Flexible(
                    ...
                    child: FutureLoadingBuilder<Map<String, String?>>(
                      initialData: {
                        "address": S.of(context)!.unnamedPlace ??
                            'Unnamed place',
                        "placeId": "101"
                      },
  ...
  Future<Map<String, String?>> getAddress(LatLng location) async {
    try {
      ...
      print("${_TAG} The End Point ::: ${endpoint}");

class ReadyToDelivery {
  String? success;
  String? statusCode;
  List<Message>? message;

  ReadyToDelivery({this.success, this.statusCode, this.message});

  ReadyToDelivery.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    statusCode = json['status_code'];
    if (json['message'] != null) {
      if (json['message'].toString().endsWith("Data Not Found")) {
        message = <Message>[];
      } else {
        print("Order message :: ${json['message']}");
